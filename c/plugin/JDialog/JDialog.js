...
//			$(".JDialog").remove();
		...
		var JDialog_head = $("<p class='JDialog-head overflow'><span class='JDialog-title f-left'>"+DialogJson.JDialog_title+"</span><span class='JDialog-close f-right'>x</span></p>")
		...
		$(".JDialog").css({"top":c_client.c_scroll_top+100});
	}
